        ...
        <div className="flex flex-col justify-between  md:flex-row gap-3">
          ...
          <div className="text-center flex flex-col md:text-left  gap-2 md:mb-0">
            ...
            <div className="flex justify-center md:justify-start items-center text-blue-600">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="mr-3 hover:text-green-800">
                <FaFacebook size={24} />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="mr-3 hover:text-green-800">
                <FaTwitter size={24} />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="mr-3 hover:text-green-800">
                <FaInstagram size={24} />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className=" hover:text-green-800">
                <FaLinkedin size={24} />
              </a>
            </div>
          </div>

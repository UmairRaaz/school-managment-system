  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4 mt-28 max-w-2xl mx-auto">
      ...
      <div>
        ...
        <label htmlFor="SID" className="block text-xs font-medium text-gray-700">SID</label>
        <input
          type="text"
          id="SID"
      ...
      {/* FatherName */}
      <div>
        <label htmlFor="FatherName" className="block text-xs font-medium text-gray-700">Father's Name</label>
        <input
          type="text"
          id="FatherName"
      ...
      {/* AdmissionDate */}
      <div>
        <label htmlFor="AdmissionDate" className="block text-xs font-medium text-gray-700">Admission Date</label>
        <input
          type="date"
          id="AdmissionDate"
      ...
      {/* SeatNumber */}
      <div>
        <label htmlFor="SeatNumber" className="block text-xs font-medium text-gray-700">Seat Number</label>
        <input
          type="text"
          id="SeatNumber"
      ...
      {/* AdmissionClass */}
      <div>
        <label htmlFor="AdmissionClass" className="block text-xs font-medium text-gray-700">Admission Class</label>
        <input
          type="text"
          id="AdmissionClass"
      ...
      {/* GRNo */}
      <div>
        <label htmlFor="GRNo" className="block text-xs font-medium text-gray-700">GR No.</label>
        <input
          type="text"
          id="GRNo"
      ...
      {/* Section */}
      <div>
        <label htmlFor="Section" className="block text-xs font-medium text-gray-700">Section</label>
        <input
          type="text"
          id="Section"
      ...
      {/* CNICNumber */}
      <div>
        <label htmlFor="CNICNumber" className="block text-xs font-medium text-gray-700">CNIC Number</label>
        <input
          type="text"
          id="CNICNumber"
      ...
      {/* Caste */}
      <div>
        <label htmlFor="Caste" className="block text-xs font-medium text-gray-700">Caste</label>
        <input
          type="text"
          id="Caste"
      ...
      {/* FamilyNumber */}
      <div>
        <label htmlFor="FamilyNumber" className="block text-xs font-medium text-gray-700">Family Number</label>
        <input
          type="text"
          id="FamilyNumber"
      ...
      {/* CurrentClass */}
      <div>
        <label htmlFor="CurrentClass" className="block text-xs font-medium text-gray-700">Current Class</label>
        <input
          type="text"
          id="CurrentClass"
      ...
      {/* PlaceOfBirth */}
      <div>
        <label htmlFor="PlaceOfBirth" className="block text-xs font-medium text-gray-700">Place of Birth</label>
        <input
          type="text"
          id="PlaceOfBirth"
      ...
      {/* Religion */}
      <div>
        <label htmlFor="Religion" className="block text-xs font-medium text-gray-700">Religion</label>
        <input
          type="text"
          id="Religion"
      ...
      {/* ReligionStatus */}
      <div>
        <label htmlFor="ReligionStatus" className="block text-xs font-medium text-gray-700">Religion Status</label>
        <input
          type="text"
          id="ReligionStatus"
      ...
      {/* Reason */}
      <div>
        <label htmlFor="Reason" className="block text-xs font-medium text-gray-700">Reason</label>
        <input
          type="text"
          id="Reason"
      ...
      {/* Remarks */}
      <div>
        <label htmlFor="Remarks" className="block text-xs font-medium text-gray-700">Remarks</label>
        <input
          type="text"
          id="Remarks"
      ...
      {/* AdmissionNote */}
      <div>
        <label htmlFor="AdmissionNote" className="block text-xs font-medium text-gray-700">Admission Note</label>
        <input
          type="text"
          id="AdmissionNote"
      ...
      {/* Nationality */}
      <div>
        <label htmlFor="Nationality" className="block text-xs font-medium text-gray-700">Nationality</label>
        <input
          type="text"
          id="Nationality"
      ...
      {/* LeaveDate */}
      <div>
        <label htmlFor="LeaveDate" className="block text-xs font-medium text-gray-700">Leave Date</label>
        <input
          type="date"
          id="LeaveDate"
      ...
      {/* LastSchool */}
      <div>
        <label htmlFor="LastSchool" className="block text-xs font-medium text-gray-700">Last School</label>
        <input
          type="text"
          id="LastSchool"
      ...
      {/* LastSchoolGroup */}
      <div>
        <label htmlFor="LastSchoolGroup" className="block text-xs font-medium text-gray-700">Last School Group</label>
        <input
          type="text"
          id="LastSchoolGroup"
      ...
      <div>
        <label htmlFor="AdmissionFeeDiscount" className="block text-xs font-medium text-gray-700">Admission Fee Discount</label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="ApprovedAdmissionFee" className="block text-xs font-medium text-gray-700">Approved Admission Fee</label>
        <input
          type="text"
      ...
      {/* LabCharges */}
      <div>
        <label htmlFor="LabCharges" className="block text-xs font-medium text-gray-700">Lab Charges</label>
        <input
          type="text"
          id="LabCharges"
          step="any"
      ...
      {/* LabChargesDiscount */}
      <div>
        <label htmlFor="LabChargesDiscount" className="block text-xs font-medium text-gray-700">Lab Charges Discount</label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="ApprovedLabChargesFee" className="block text-xs font-medium text-gray-700">Approved Lab Charges Fee</label>
        <input
          type="text"
      ...
      {/* TuitionFee */}
      <div>
        <label htmlFor="TuitionFee" className="block text-xs font-medium text-gray-700">Tuition Fee</label>
        <input
          type="text"
          id="TuitionFee"
          step="any"
      ...
      {/* TuitionFeeDiscount */}
      <div>
        <label htmlFor="TuitionFeeDiscount" className="block text-xs font-medium text-gray-700">Tuition Fee Discount</label>
        <input
          type="text"
      ...
      {/* ApprovedTuitionFee */}
      <div>
        <label htmlFor="ApprovedTuitionFee" className="block text-xs font-medium text-gray-700">Approved Tuition Fee</label>
        <input
          type="text"
      ...
      {/* CoursePayment */}
      <div>
        <label htmlFor="CoursePayment" className="block text-xs font-medium text-gray-700">Course Payment</label>
        <input
          type="text"
          id="CoursePayment"
          step="any"
      ...
      <div>
        <label htmlFor="CoursePaymentDiscount" className="block text-xs font-medium text-gray-700">Course Payment Discount</label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="ApprovedCoursePayment" className="block text-xs font-medium text-gray-700">Approved Course Payment</label>
        <input
          type="text"
      ...
      {/* StationaryCharges */}
      <div>
        <label htmlFor="StationaryCharges" className="block text-xs font-medium text-gray-700">Stationary Charges</label>
        <input
          type="text"
      ...
      {/* AnnualCharges */}
      <div>
        <label htmlFor="AnnualCharges" className="block text-xs font-medium text-gray-700">Annual Charges</label>
        <input
          type="text"
          id="AnnualCharges"
          step="any"
      ...
      {/* SchoolFee */}
      <div>
        <label htmlFor="SchoolFee" className="block text-xs font-medium text-gray-700">School Fee</label>
        <input
          type="text"
          id="SchoolFee"
          step="any"
      ...
      {/* Arrears */}
      <div>
        <label htmlFor="Arrears" className="block text-xs font-medium text-gray-700">Arrears</label>
        <input
          type="text"
          id="Arrears"
          step="any"
      ...
      {/* StudentImage */}
      <div>
        <label htmlFor="StudentImage" className="block text-xs font-medium text-gray-700">Student Image</label>
        <input
          type="text"
          id="StudentImage"

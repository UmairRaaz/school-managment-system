        ...
        <div className="flex flex-col justify-between  md:flex-row gap-3">
          ...
          <div className="text-center md:text-left mb-4 md:mb-0">
            ...
            <ul className="text-gray-700">
              <li className="mb-2">Email: thezaissystem@gmail.com </li>
              <li className="mb-2">Phone: 03369981971</li>
              <li className="mb-2">Address: Bungalow no 99A unit no 2 latifabad Hyd</li>
            </ul>
          </div>

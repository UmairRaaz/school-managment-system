...
const ContactPage = () => {
  return (
    <div
      id="contact"
      className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 via-purple-200 to-indigo-200"
    >
      <div className="container mx-auto p-8 lg:p-16  ">
        <h1 className="text-4xl lg:text-6xl font-extrabold  bg-clip-text bg-gradient-to-r from-blue-500  text-[#fe9800] to-pink-400 text-center mb-12">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-around space-y-12 lg:space-y-0 lg:space-x-12">
          ...
          <div className="flex flex-col items-center text-gray-800 bg-gradient-to-r from-blue-200 to-blue-200 p-8 rounded-2xl shadow-lg transform hover:scale-105 transition duration-500">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-pink-400 text-center mb-8">
              Contact Information
            </h2>
            ...
            <div className="flex space-x-6 text-4xl">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-pink hover:text-pink-400 transition duration-300 transform hover:scale-125"
              >
                <FaInstagram />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue hover:text-blue-400 transition duration-300 transform hover:scale-125"
              >
                <FaFacebook />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple hover:text-blue-600 transition duration-300 transform hover:scale-125"
              >
                <FaLinkedin />
              </a>
            </div>

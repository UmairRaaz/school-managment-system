      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap justify-end gap-2">
          <button
            ...
            className="py-2 px-8   text-white border bg-black rounded-lg"
          >
            All
          </button>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none py-2 px-2 bg-black text-white rounded-lg"
            >
          ...
          <div className="relative">
            <select
              onChange={(e) => setTimeFilter(e.target.value)}
              className="appearance-none py-2 px-8  bg-black text-white rounded-lg"
            >

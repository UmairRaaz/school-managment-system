...
const AdminViewClassNotificationPage = () => {
  ...
  return (
    <div className="p-4 mt-24 px-10">
      <h1 className="text-2xl font-bold mb-4">Class Notifications</h1>
          ...
          {classNotifications.map((notification) => (
            ...
            >
              <h2 className="text-xl font-semibold mb-2 flex gap-4 items-center">
                {notification.title}
                <div className="text-sm cursor-pointer" onClick={()=>handleEdit(notification._id)}>Edit</div>
                <div className="text-sm cursor-pointer" onClick={()=>handleView(notification._id)}>View</div>
                <div className="text-sm cursor-pointer" onClick={()=>handleDelete(notification._id)}>Delete</div>
              </h2>
...
export default AdminViewClassNotificationPage
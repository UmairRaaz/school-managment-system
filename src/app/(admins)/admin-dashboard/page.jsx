    ...
    <div className="max-w-6xl mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-blue-600 mr-4"><FaUserGraduate /></div>
          <div>
        ...
        {/* Total Teachers */}
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-yellow-600 mr-4"><FaChalkboardTeacher /></div>
          <div>
        ...
        {/* Total Amount */}
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-green-600 mr-4"><FaMoneyBillWave /></div>
          <div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-purple-600 mr-4"><FaLaptop /></div>
          <div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-red-600 mr-4"><FaUserNurse /></div>
          <div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center">
          <div className="text-4xl text-indigo-600 mr-4"><FaUserCheck /></div>
          <div>

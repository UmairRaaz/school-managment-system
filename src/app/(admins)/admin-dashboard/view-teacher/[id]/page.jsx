                    ...
                    <div className="bg-gray-50 p-8 w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center text-gray-700">
                                ...
                                <span className="ml-2 text-sm md:text-base">{teacher.phoneNumber}</span>
                            </div>
                            <div className="flex items-center text-gray-700">
                                <FaChalkboardTeacher className="text-indigo-500 mr-2 md:mr-3" />
                                <span className="font-semibold text-sm md:text-base">Classes:</span>
                            ...
                            <div className="flex items-center text-gray-700">
                                ...
                                <span className="font-semibold text-sm md:text-base">Subjects:</span>
                                <div className="ml-2 flex flex-wrap">
                                    {teacher.subjects.map((subject, index) => (
                                        <span key={index} className="bg-gray-200 rounded-full px-2 py-1 text-xs md:text-sm font-semibold text-gray-700 mr-1 mb-1 md:mr-2 md:mb-2">{subject}</span>
                                    ))}
                                </div>
                            </div>
                        </div>

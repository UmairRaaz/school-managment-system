            ...
            >
              ...
              <section className="mb-2">
                <p className="mb-2 text-xs">
                  <span className="font-semibold">S.No:</span> 67890
                </p>
                <p className="mb-2 text-xs">
                  <span className="font-semibold">Name:</span> Moon Khan
                </p>
                <p className="mb-2 text-xs">
                  <span className="font-semibold">Father Name:</span> Rustam Khan
                </p>
                <p className="mb-2 text-xs">
                  <span className="font-semibold">Roll Number:</span> 21BSCS34
                </p>
                <p className="mb-2 text-xs">
                  <span className="font-semibold">Class:</span> 6th
                </p>
                <p className="mb-2 text-xs">
